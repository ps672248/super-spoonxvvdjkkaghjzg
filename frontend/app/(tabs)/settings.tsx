...
export default function SettingsScreen() {
  ...
  const {
    geminiApiKey, geminiModel, fullName, userIntroduction, categoryId,
    setApiKey, setModel, setFullName, setUserIntroduction, setCategory,
  } = useSettingsStore();
          ...
          <View style={[styles.card, isWide && styles.cardWide]}>
            ...
            <View style={styles.cardInner}>
              <View style={styles.cardTitleRow}>
                ...
                <Text style={styles.cardTitle}>Study Category</Text>
              </View>

              <View style={styles.field}>
                <Text style={styles.fieldLabel}>CATEGORY</Text>
                <TouchableOpacity
                  style={[styles.inputContainer, isCategoryOpen && styles.inputContainerActive]}
                  onPress={toggleCategoryDropdown}
                  activeOpacity={0.7}
                >
                  <Ionicons name={selectedCategory.ionicon as any} size={18} color={Colors.primary} />
                  <Text style={styles.inputText} numberOfLines={1}>{selectedCategory.name}</Text>
                  <View style={styles.dropdownIcons}>
                    <Ionicons name={isCategoryOpen ? 'chevron-up' : 'chevron-down'} size={16} color={Colors.outline} />
                  </View>
                </TouchableOpacity>
                  ...
                  <View style={styles.dropdownList}>
                    {CATEGORIES.map((cat) => (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                      >
                        <Ionicons name={cat.ionicon as any} size={18} color={cat.id === categoryId ? Colors.primary : Colors.outline} />
                        <View style={{ flex: 1 }}>
                          <Text style={[styles.dropdownItemLabel, cat.id === categoryId && styles.dropdownItemLabelActive]} numberOfLines={1}>
                            {cat.name}
                          </Text>
                        </View>
                        {cat.id === categoryId && (
                ...
                <Text style={styles.helperText}>Determines which exams appear on the home screen.</Text>
              </View>
            </View>
          </View>
